...
UPSTREAM_REPO="https://github.com/MiSTer-devel/TK2000_MiSTer.git"
CORE_NAME=(TK2000)
...
UPSTREAM_CORE_NAME=(TK2000)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(TK2000.qpf)
COMPILATION_OUTPUT=(output_files/TK2000.rbf)
